...
<body>
    ...
    <div class="output">
        ...
        $student = new Student("Oisín Rodríguez", "S1234567");
        // $student->name = "Oisín Rodríguez";
    ...
    <div class="output">
        ...
        $student1 = new Student("Liam Al-Masri", "S7654321");
        $student2 = new Student("Fatima Ní Bhraonáin", "S1122334");
        ...
        echo "Student 2 Number: " . $student2->getNumber() . "<br/>";
        ?>
    </div>
    ...
    <div class="output">
        ...
        // TODO: Write your solution here
        require_once __DIR__ . '/classes/Student.php';
        $student = new Student("Sakura Nguyen", "S9988776");
