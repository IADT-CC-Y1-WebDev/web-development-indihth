...
<body>
    ...
    <div class="output">
        ...
        $student1 = new Student("Maria Guadalupe", "S00123456");
        echo "Created student: " . $student1 . "<br/>";
        echo "Current student count: " . Student::getCount() . "<br/>";

        $student2 = new Student("Mariia Shevchenko", "S00234567");
        echo "Created student: " . $student2 . "<br/>";
        echo "Current student count: " . Student::getCount() . "<br/>";

        $student3 = new Student("Yovan Setiawan", "S00345678");
        echo "Created student: " . $student3 . "<br/>";
        echo "Current student count: " . Student::getCount() . "<br/>";
        ?>
    </div>
    ...
    <div class="output">
        ...
        // TODO: Write your solution here
        require_once __DIR__ . '/classes/Student.php';
        $student1 = new Student("Ana Silva", "S00456789");
        $student2 = new Student("Leo Müller", "S00567890");
        $student3 = new Student("Sofia Rossi", "S00678901");
        ...
        $searchNumbers = [
            "S00567890",
            "S99999999" // Non-existent student number
        ];
        foreach ($searchNumbers as $searchNumber) {
            $foundStudent = Student::findByNumber($searchNumber);
            if ($foundStudent !== null) {
                echo "Found student with number $searchNumber: " . $foundStudent . "<br/>";
            } else {
                echo "No student found with number $searchNumber<br/>";
            }
        }
        ?>
    </div>
    ...
    <div class="output">
        ...
        $student1 = new Student("Carlos Diaz", "S00789012");
        $undergrad1 = new Undergrad("Emma Johnson", "S00890123", "Computer Science", 4);
        $postgrad1 = new Postgrad("Chikondi Mtawali", "S00901234", "Dr. Mtawali", "The UX of AI");

        echo "All Students (including Undergrads and Postgrads):<br/>";
        $allStudents = Student::findAll();
        foreach ($allStudents as $student) {
            echo $student . "<br/>";
        }

        $searchNumber = "S00890123";
        $foundStudent = Student::findByNumber($searchNumber);
        if ($foundStudent !== null) {
            echo "Found student with number $searchNumber: " . $foundStudent . "<br/>";
        } else {
    ...
    <div class="output">
        ...
        // TODO: Write your solution here
        require_once __DIR__ . '/classes/Student.php';
        $student1 = new Student("Linar Svensson", "S01012345");
        $student2 = new Student("Alice Brown", "S01123456");
        $student3 = new Student("Cristina Calderón", "S01234567");

        echo "Current student count: " . Student::getCount() . "<br/>";
        $student2->leave();
        unset($student2);

        echo "Current student count after one leaves: " . Student::getCount() . "<br/>";
        ?>
    </div>
