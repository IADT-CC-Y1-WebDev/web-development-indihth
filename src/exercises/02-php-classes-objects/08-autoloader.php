...
<body>
    ...
    <div class="output">
        ...
        use College\Student;
        $student = new Student("Manon Dubois", "C00012345");
        echo $student;
        ?>
    </div>
    ...
    <div class="output">
        ...
        $student2 = new Student("Liam O'Connor", "C00098765");
        echo $student2 . "<br/>";

        $undergrad = new Undergrad("Youssef Idrissi", "C00054321", "Computer Science", 2);
        echo $undergrad . "<br/>";

        $postgrad = new Postgrad("Nguyễn Thị Linh", "C00067890", "Dr. Smith", "Artificial Intelligence");
        echo $postgrad . "<br/>";
        ?>
    </div>
    ...
    <div class="output">
        ...
        $s1 = new Student("Alice Murphy", "C00011111");
        $s2 = new Undergrad("Bob Zhang", "C00022222", "Engineering", 3);
        $s3 = new Postgrad("Carla Rossi", "C00033333", "Prof. Johnson", "Data Science");
