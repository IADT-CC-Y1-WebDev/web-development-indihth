...
<body>
    ...
    <div class="output">
        ...
        echo "Undergrad Name: " . $undergrad->getName();
        ?>
    </div>
    ...
    <div class="output">
        ...
        // TODO: Write your solution here
        require_once __DIR__ . '/classes/Undergrad.php';
        $undergrad2 = new Undergrad("Winona Sequoyah", "U09876543", "Mathematics", 3);
    ...
    <div class="output">
        ...
        require_once __DIR__ . '/classes/Undergrad.php';
        $students = [
            new Undergrad("Eleni Ioannidis", "U11111111", "Biology", 1),
            new Undergrad("Emma Williams", "U22222222", "History", 2),
            new Undergrad("Alessandro Lombardi", "U33333333", "Engineering", 3)
        ];
        ?>
    </div>
