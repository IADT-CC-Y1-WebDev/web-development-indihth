...
<body>
    ...
    <div class="output">
        ...
        $student1 = new Student("Eoin Murphy", "S1122334");
        $student2 = new Student("Niamh Kelly", "S5566778");
        ?>
    </div>
    ...
    <div class="output">
        ...
        $student = new Student("Finn MacCarthy", "S3344556");
        echo $student;
        ?>
    </div>
    ...
    <div class="output">
        ...
        $students = [
            new Student("Aoife Brennan", "S4455667"),
            new Student("Mei Zheng", "S7788990"),
            new Student("Kwame Adeyemi", "S9900112")
        ];
    ...
    <div class="output">
        ...
        $student1 = new Student("Théo Hernandez", "S0012345");
        $student2 = new Student("Litia Caucau", "S00234567");
