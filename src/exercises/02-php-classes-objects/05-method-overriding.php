...
<body>
    ...
    <div class="output">
        ...
        $student = new Student("Jaime Hughes", "S12345678");
        $undergrad = new Undergrad("Alicja Pacuła", "U01234567", "Computer Science", 2);
    ...
    <div class="output">
        ...
        $postgrad = new Postgrad("Liam O'Connor", "P98765432", "Dr. Smith", "Artificial Intelligence");
        echo $postgrad;
        ?>
    </div>
    ...
    <div class="output">
        ...
        $students = [
            new Student("Haruto  Tanaka", "S12345678"),
            new Undergrad("Bahar Mahjoub", "U01234567", "Fine Art", 2),
            new Postgrad("Kofi Mensah", "P98765432", "Dr. Smith", "Theoretical Physics")
        ];
