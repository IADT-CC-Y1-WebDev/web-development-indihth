...
<body>
    ...
    <div class="output">
        ...
        $student = new \College\Student("Alice", "C12345000");
        echo $student;
        ?>
    </div>
    ...
    <div class="output">
        ...
        $student = new Student("Bob", "C00012346");
        echo $student;
        ?>
    </div>
    ...
    <div class="output">
        ...
        $student = new Student("Charlie", "C00012347");
        $undergrad = new Undergrad("Zainab", "C00012348", "Computer Science", 1);
        $postgrad = new Postgrad("Francisco", "C00012349", "Dr. Pereira", "AI Ethics");
